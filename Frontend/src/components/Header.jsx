...
function Header() {
    ...
    return (
        <div className="grid grid-rows-2 shadow-md fixed top-0 left-0 right-0">
            <div className={`force-ltr px-8 flex bg-[#F8F8F5] border-b-1 border-gray-100  ${isSignUpModal || isLoginModal ? "z-10" : "z-50"} `} >
